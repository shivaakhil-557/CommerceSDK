...
import GenericStaticClass from "../../Entities/Common";
...
export default class CustomFieldsSection extends CustomerAddEditCustomControlBase {
    ...
    public init(state: ICustomerAddEditCustomControlState): void {
        if (!state.isSelectionMode) {
            ...
            if (!ObjectExtensions.isNullOrUndefined(GenericStaticClass.CustomerDetails)) {
                GenericStaticClass.CustomerDetails.ReceiptEmail = '';
                this.customer = GenericStaticClass.CustomerDetails;
                GenericStaticClass.CustomerDetails = undefined;
            }
        }
    }
