...
import { GasPumpStatus } from "../../Entities/GasStationTypes";
import { NumberFormattingHelper } from "../../Utilities/NumberFormattingHelper";
...
import {
    ISimpleProductDetailsToExtensionCommandMessageTypeMap,
    SimpleProductDetailsExtensionCommandBase, SimpleProductDetailsProductChangedData
} from "PosApi/Extend/Views/SimpleProductDetailsView";
import { GasStationDataStore } from "../../Entities/GasStationDataStore";
import PumpGasDialog from "../../Controls/Dialogs/Create/GasStation/PumpGasDialog";
